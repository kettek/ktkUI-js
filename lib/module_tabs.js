...
var tabs_module = (function() {
  ...
  sheet.addRule('tabs', 'box-sizing: border-box; position: relative; display: flex; flex-direction: column; align-items: stretch; align-content: stretch; width: 100%; height: 100%; border: 1px solid rgba(196, 196, 32, 0.1); background-color: rgba(196, 196, 32, 0.1)');
  sheet.addRule('tabs-list', 'position: relative; display: flex; flex-direction: row; align-items: stretch; align-contents: stretch;');
  sheet.addRule('tabs-list-tab', 'box-sizing: border-box; cursor: pointer; position: relative; flex-grow: 1; flex-shrink: 1; flex-basis: 0; padding: 0.1em; text-align: center; border: 1px outset rgba(196, 196, 32, 0.25); background-color: rgba(196, 196, 32, 0.25)');
  ...
  sheet.addRule('tabs-list-tab.selected', 'font-weight: 600; box-sizing: border-box; border: 1px inset rgba(196, 196, 32, 0.25); background-color: rgba(196, 196, 32, 0.1)');
  ...
  function handleTab(el) {
    ...
    if (tabs_list.firstChild == tabs_list_tab) tabs_list_tab.dispatchEvent(new Event('click'));
  }
