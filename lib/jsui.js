...
var tabs_module = (function() {
  var sheet = prependStyleSheet();
  sheet.addRule('tabs', 'position: relative; display: flex; flex-direction: column; align-items: stretch; align-content: stretch; width: 100%; height: 100%;');
  ...
  function handleTab(el) {
    ...
    var tabs_content = tabs.getElementsByTagName('tabs-content')[0];
    tabs_content.appendChild(el);
    el.style.display = 'none';
    // create a new 'tabs-list-tab' and add to 'tabs-list'
    var tabs_list = tabs.getElementsByTagName('tabs-list')[0];
    ...
    tabs_list_tab.addEventListener('click', function(e) {
      ...
      var tabs = tabs_content.getElementsByTagName('tab');
