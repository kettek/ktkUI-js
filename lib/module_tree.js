var tree_module = (function() {
  ...
  sheet.addRule('tree', 'box-sizing: border-box; position: relative; display: block; margin-left: 0.25em;');
  sheet.addRule('tree-branches', 'position: relative; box-sizing: border-box; display: inline-block; margin-left: 1em;');
  ...
  sheet.addRule('branch', 'box-sizing: border-box; display: block;');
